...
import { InviteePrivateAutocompleteField } from './InviteePrivateAutocompleteField'
import { MembersHostPresenceAutocompleteField } from './MembersHostPresenceAutocompleteField'
import { BeneficiaryAutocompleteField } from './BeneficiaryAutocompleteField'
import ImageExperienceField from './ImageExperienceField'
import GalleryUploadField from './GalleryUploadField'
import { showErrorAlert } from '../../../../helpers/alert'

const Step2: FC<Props> = ({ onNextStep, onBackStep }) => {
    ...
    const handleFocus = () => {
        ...
        const formatted = formik.values.price_per_guest;
        if (!formatted) return;

        // Quitar formato: $ , . etc.
        const numeric = formatted.replace(/[^0-9]/g, "");
        const cleaned = numeric.slice(0, -2);
        formik.setFieldValue("price_per_guest", cleaned);
    };

    // Cuando el usuario escribe
    const handleChange = (e: any) => {
        const raw = e.target.value.replace(/[^0-9]/g, "");
        formik.setFieldValue("price_per_guest", raw);
    ...
    const handleBlur = () => {
        ...
        const raw = formik.values.price_per_guest;
        if (!raw) return;

        const numberValue = Number(raw);
        const formatted = formatter.format(numberValue);

        formik.setFieldValue("price_per_guest", formatted);
        formik.setFieldValue("price_per_guest_raw", numberValue);
    };

    /* aquí vamos a tener estos datos de prueba */
    ...
    const handleInviteesChange = (value:string) => {
        formik.setFieldValue("invitees", value);
        formik.validateForm();
    };
    ...
    const handleAdditionalTeamMembersChange = (value:string) => {
        formik.setFieldValue("additionalTeamMembers", value);
        formik.validateForm();
    };
        ...
        <div className="tap-add-experience-2-wrapper-container">
            <div className="tap-add-experience-2-wrapper">
                ...
                <div className="tap-add-experience-2-header">
                    <div className="tap-add-experience-2-title">Host Experience</div>
                </div>
                {/* <!-- 2. STEP HEADER --> */}
                <div className="tap-add-experience-2-step-header">
                ...
                <section className="tap-add-experience-2-section">
                    ...
                    <div>
                        <div className="tap-add-experience-2-input-line h-auto">
                            <textarea name="itinerary" value={formik.values.itinerary} onChange={formik.handleChange} className="tap-add-experience-2-input textarea-autosize" onInput={handleTextAreaInput} ref={textareaRef} maxLength={200} />
                        </div>
                ...
                <section className="tap-add-experience-2-section">
                    ...
                    <div>
                        <div className="tap-add-experience-2-input-line">
                            <input name='what_is_included' value={formik.values.what_is_included} onChange={formik.handleChange} className="tap-add-experience-2-input" maxLength={200} />
                        </div>
                        <div className="tap-add-experience-2-input-hint mt-3">
                    ...
                    <div className="tap-add-experience-2-duration-box">
                        <div className="tap-add-experience-2-duration-header">
                            ...
                            <div className="tap-add-experience-2-duration-right">
                                ...
                                <select name="durationType" value={formik.values.durationType} onChange={formik.handleChange} className='tap-select-add-experience' placeholder='Select an option'>
                                    {(duration ?? []).map((r,index)=>
                                        (<option key={`duration-${index}`} value={r.id}>{r.duration}</option>)
                                    )}
                                </select>
                            </div>
                        </div>
                        <ErrorMessage name="duration" component="div" className="tap-add-experience-text text-danger" />
                        <ErrorMessage name="durationType" component="div" className="tap-add-experience-text text-danger" />
                ...
                <section className="tap-add-experience-2-section">
                    ...
                    <div className="tap-add-experience-2-price-box">
                        <div className="tap-add-experience-2-price-left w-100">
                            <span>USD </span>
                            <input name="price_per_guest" type='text' value={formik.values.price_per_guest} onFocus={handleFocus} onChange={handleChange} onBlur={handleBlur}className="tap-add-experience-2-input" max={1000000000} maxLength={10} />
                        </div>
                        <div className="tap-add-experience-2-price-right">/Guest</div>
                    </div>
                    <ErrorMessage name="price_per_guest" component="div" className="tap-add-experience-text text-danger" />
                </section>
                ...
                <section className="tap-add-experience-2-section">
                    ...
                    <div className="tap-add-experience-2-radio-list">
                        <div className={`tap-add-experience-2-radio-card ${formik.values.inviteGuestType === "public" ? 'tap-add-experience-2-radio-card--selected' : ''}`}>
                            <label className="tap-host-option p-6 w-100">
                                <input
                                    type="radio"
                                    name="inviteGuestType"
                                    value="public"
                                    className="tap-host-radio-input"
                                    checked={formik.values.inviteGuestType === "public"}
                        ...
                        <div className={`tap-add-experience-2-radio-card ${formik.values.inviteGuestType === "private" ? 'tap-add-experience-2-radio-card--selected' : ''}`}>
                            <label className="tap-host-option p-6 w-100">
                                <input disabled={userData?.subscription?.status != 'active'}
                                    ...
                                    value="private"
                                    className={`tap-host-radio-input`}
                                    checked={formik.values.inviteGuestType === "private"}
                                    onChange={handleInviteGuestsChange}
                                />
                                <div className="tap-host-radio">
                                    <div className="tap-host-radio-outer"></div>
                    ...
                    <div className={`w-100 flex-column ${formik.values.inviteGuestType === "private" ? 'd-flex' : 'd-none'}`}>
                        <InviteePrivateAutocompleteField values={formik.values.invitees} onChange={handleInviteesChange}/>
                    </div>
                    <ErrorMessage name={`invitees`} component="div" className={`tap-add-experience-text text-danger ${formik.values.inviteGuestType === "private" ? 'd-flex' : 'd-flex'}`} />
                </section>
                {/* <!-- 13. AUDIENCE --> */}
                <section className="tap-add-experience-2-section">
                    <label className="tap-add-experience-2-section-heading">Audience</label>
                    <div className="tap-add-experience-2-radio-row">
                        <div className={`tap-add-experience-2-radio-card w-50 ${formik.values.audienceType === "family" ? 'tap-add-experience-2-radio-card--selected' : ''}`}>
                            <label className="tap-host-option p-6 w-100">
                                <input
                                    type="radio"
                                    name="audienceType"
                                    value="family"
                                    className="tap-host-radio-input"
                                    checked={formik.values.audienceType === "family"}
                                    onChange={formik.handleChange}
                                />
                                <div className="tap-host-radio">
                                    <div className="tap-host-radio-outer"></div>
                                ...
                                <div className="tap-host-option-label">Family Welcome</div>
                            </label>
                        </div>
                        <div className={`tap-add-experience-2-radio-card w-50 ${formik.values.audienceType === "adults" ? 'tap-add-experience-2-radio-card--selected' : ''}`}>
                            <label className="tap-host-option p-6 w-100">
                                <input
                                    type="radio"
                                    name="audienceType"
                                    value="adults"
                                    className="tap-host-radio-input"
                                    checked={formik.values.audienceType === "adults"}
                                    onChange={formik.handleChange}
                                />
                                <div className="tap-host-radio">
                                    <div className="tap-host-radio-outer"></div>
                                ...
                                <div className="tap-host-option-label">Exclusively Adults</div>
                            </label>
                        </div>
                    </div>
                    <div className="tap-add-experience-2-description">
                ...
                <section className="tap-add-experience-2-section">
                    ...
                    <div className="tap-add-experience-2-capacity-row">
                        <div className={`tap-add-experience-2-capacity-col ${formik.values.audienceType == 'family' || formik.values.audienceType == 'adults' ? 'd-flex' : 'd-none' }`}>
                        ...
                        <div className={`tap-add-experience-2-capacity-col ${formik.values.audienceType == 'family' ? 'd-flex' : 'd-none' }`}>
                ...
                <section className="tap-add-experience-2-section">
                    ...
                    <div>
                        <div className="tap-add-experience-2-input-line">
                            <input name="important_information_guest" value={formik.values.important_information_guest} onChange={formik.handleChange} className="tap-add-experience-2-input" maxLength={100} />
                        </div>
                ...
                <section className="tap-add-experience-2-section">
                    ...
                    <div className="tap-add-experience-2-input-group">
                        ...
                        <div className="tap-add-experience-2-input-line">
                            <input name="idealAudience" value={formik.values.idealAudience} onChange={formik.handleChange} className="tap-add-experience-2-input" maxLength={100} />
                        </div>
                ...
                <section className="tap-add-experience-2-section">
                    ...
                    <div>
                        <div className="tap-add-experience-2-input-line">
                            <input name="participation" value={formik.values.participation} onChange={formik.handleChange} className="tap-add-experience-2-input" maxLength={100} />
                        </div>
                        <div className="tap-add-experience-2-input-hint mt-3">
                            E.g. Full duration, Opening Dinner (min. 3 hours), or Final Day
                        </div>
                        <ErrorMessage name={`participation`} component="div" className="tap-add-experience-text text-danger" />
                    </div>
                    <div className="tap-add-experience-2-label">
                    ...
                    <div>
                        <div className={`w-100 flex-column`}>
                            <MembersHostPresenceAutocompleteField values={formik.values.additionalTeamMembers} onChange={handleAdditionalTeamMembersChange}/>
                        </div>
                        <ErrorMessage name={`additionalTeamMembers`} component="div" className={`tap-add-experience-text text-danger`} />
                    </div>
                </section>
                {/* <!-- 18. BENEFICIARY --> */}
                <section className="tap-add-experience-2-section">
                    ...
                    <div className="tap-add-experience-2-radio-row">
                        <div className={`tap-add-experience-2-radio-card w-50 ${formik.values.beneficiaryType === "forProfit" ? 'tap-add-experience-2-radio-card--selected' : ''}`}>
                            <label className="tap-host-option p-6 w-100">
                                <input
                                    type="radio"
                                    ...
                                    value="forProfit"
                                    className="tap-host-radio-input"
                                    checked={formik.values.beneficiaryType === "forProfit"}
                                    onChange={formik.handleChange}
                        ...
                        <div className={`tap-add-experience-2-radio-card w-50 ${formik.values.beneficiaryType === "nonProfit" ? 'tap-add-experience-2-radio-card--selected' : ''}`}>
                            <label className="tap-host-option p-6 w-100">
                                <input
                                    type="radio"
                                    name="beneficiaryType"
                                    value="nonProfit"
                                    className="tap-host-radio-input"
                                    checked={formik.values.beneficiaryType === "nonProfit"}
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                />
                                <div className="tap-host-radio">
                    ...
                    <label className={`tap-add-experience-2-checkbox-row ${formik.values.beneficiaryType === "nonProfit" ? 'd-flex' : 'd-none'}`} for="beneficiaryCheck">
                        <div className="tap-add-experience-2-checkbox">
                            <input id="beneficiaryCheck" className="tap-add-experience-2-checkbox-box" name='beneficiaryCheck' value={formik.values.beneficiaryCheck} onChange={formik.handleChange} onBlur={formik.handleBlur} type="checkbox" />
                        </div>
                    ...
                    <ErrorMessage name={`beneficiaryCheck`} component="div" className={`tap-add-experience-text text-danger`} />
                    <div className="tap-add-experience-2-label">
                        Select beneficiary
                    </div>
                    <div className={`w-100 flex-column`}>
                ...
                <div className="tap-add-experience-2-footer">
                    ...
                    <div className="tap-add-experience-2-footer-right">
                        <div className="tap-add-experience-2-btn-secondary" onClick={()=>{showErrorAlert({title: 'Comming Soon',message: '',confirmButtonText: 'OK'});}}>
