...
const validationSchemaForDraftEdit = Yup.object({
    /* step1  */
    id: Yup.number(),
    experienceType: Yup.string().required("Please select an option"),
    /* step2  */
...
const validationSchemaPendingEdit = Yup.object({
    /* step1  */
    id: Yup.number(),
    experienceType: Yup.string().required("Please select an option"),
    /* step2  */
...
export { validateShowButtonActions, validationSchemaForDraft, validationSchemaForPending, validationSchemaForDraftEdit, validationSchemaPendingEdit };