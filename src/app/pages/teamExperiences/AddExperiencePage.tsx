...
const AddExperiencePage: FC = () => {
    ...
    const stepFields = {
        1: ["experienceType"],
        2: ["title", "itinerary", "what_is_included", "availability_type", "dates_data", "duration_type", "duration", "price_per_guest_text", "enhancements_data", "category_ids", "location_address",
