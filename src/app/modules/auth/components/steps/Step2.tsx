  ...
  return (
    <div className='w-100'>
      <HeaderText
        ...
        subtitle='Nobilis is member-led community where every member is contributor and participant.'
      />
      ...
      <div className='mb-0 fv-row'>
        ...
        {/* BLOQUE 2 */}
        <div className='form-label nbq-title fs-7'>HOW ARE YOU PLANNING TO PARTICIPATE IN NOBILIS?</div>
        <div className='nbq-hint'>Select all that apply</div>
        ...
        {/* OTHER */}
        <label className='nbq-option mb-5'>
          <span className='nbq-check'>
        ...
        {/* Texto + divisor con fleur (lo que te desapareció) */}
        <div className='text-center'>
          <div className='nb-body mb-2'>
        ...
        {/* Acciones (Back / Next) sin romper Stepper */}
